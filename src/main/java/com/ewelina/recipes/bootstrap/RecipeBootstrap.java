package com.ewelina.recipes.bootstrap;

import com.ewelina.recipes.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> teaSppnUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        if (!teaSppnUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM not found");
        }
        ...
        UnitOfMeasure teaspoonUom = teaSppnUomOptional.get();
        ...
        guacamoleRecipe.setUrl("www.EatMe.com");
        guacamoleRecipe.setServings(4);
        guacamoleRecipe.setSource("Eat Me");
